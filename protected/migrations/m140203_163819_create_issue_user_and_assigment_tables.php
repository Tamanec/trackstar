...
class m140203_163819_create_issue_user_and_assigment_tables extends CDbMigration
{
    /*public function up()
    {
	}
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            "fk_project_user",
            "tbl_project_user_assignment", "project_id",
            "tbl_project", "id",
            "CASCADE", "RESTRICT"
        );
        ...
        $this->addForeignKey(
            "fk_user_project",
            "tbl_project_user_assignment", "user_id",
            "tbl_user", "id",
            "CASCADE", "RESTRICT"
        );
